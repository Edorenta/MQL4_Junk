...
if (boxtype==atrbox) boxsize = atrboxsize; else
if (boxtype==atrmabox) boxsize = atrmaboxsize; else
if (boxtype==hilobox) boxsize = hiloboxsize; else
if (boxtype==hilomabox) boxsize = hilomaboxsize; else
if (boxtype==hybridbox) boxsize = hybridboxsize; else
if (boxtype==hybridmabox) boxsize = hybridmaboxsize; else
boxsize = fixedpips*pt;
